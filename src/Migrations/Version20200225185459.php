 ...
 */
final class Version20200225185459 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE slide_abstract DROP code');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE slide_abstract ADD code VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
